...
IPAddress PGIP(192,168,1,43);        // your PostgreSQL server IP

const char ssid[] = "ZyXEL_KEENETIC";      //  your network SSID (name)
const char pass[] = "1234567890";      // your network password

const char user[] = "artem";       // your database user
const char password[] = "1";   // your database password
const char dbname[] = "devdb";         // your database name
