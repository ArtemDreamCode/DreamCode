...
{           ExpressTileControl                                       }
{                                                                    }
{           Copyright (c) 2011-2016 Developer Express Inc.           }
{           ALL RIGHTS RESERVED                                      }
{                                                                    }
...
private
   FGroupDefRender:TdxTileControlGroup;
   procedure SetGroupDefRender(AValue: TdxTileControlGroup);
 public
    constructor Create(AOwner: TComponent); override;
    property GroupDefRender: TdxTileControlGroup read FGroupDefRender write SetGroupDefRender;



  TdxCustomTileControl = class(TcxControl, IcxStoredParent, IcxStoredObject, IdxSkinSupport)
  piblic
   procedure EndUpdateDefRender;

  public
    procedure LayoutChangedDefRender; virtual;
...
{$ENDIF}
  ...
  cxLibraryConsts, dxHooks, dxAnimation, cxButtonEdit, cxEdit, dxMessages, Vcl.ExtCtrls
// -------------- dorofeev -------------
  , generics.collections, PNGImage, cxImage, cxCheckBox, JPEG;
...
const
  // appearances
  cPrimeraFrameColor = $00C5C5C5;
  cPrimeraSelectedColor = $00BB6F00;
  cPrimeraGroupHeaderColor = $00E8E3DF;
  ...
  dxTileControlItemMaxRowCount = 100; // rev dorofeev 09.12.2019
  dxTileControlSizeGroupBorder = 1;
  dxMaxItemsTexts = 20; {Item.Text1 .. Item.Text20} // dorofeev 20.02.2020
  ...
  dxTileCheckedItemCheckMarkAreaSize = 45;//45;
...
type
  ...
  TTileClickedRect = class(TShape)
  protected
    FSavePaint: boolean;
    CanvasBufer: Tbitmap;
    FClick: Boolean;
    FOwnerGroup: TdxTileControlGroup;
  public
    property Canvas;
  ...
  TStateItemLogic = (itlNone, itlMain, itlChild, itlMultiMain);
  ...
  protected
    ...
    procedure DoCalculate; override;
    procedure DoDraw(ACanvas: TcxCanvas); override;
    class function GetActualBorderWidth: Integer;
    function GetHitTest(AHitTest: TdxTileControlHitTest): Boolean; override;
    function GetLeftPos: Integer; override;
  ...
  private
    ...
    procedure SetValueWordWrap(AValue: string);
  ...
  protected
    ...
    function GetActualIndentHorz: Integer;
    function GetActualIndentVert: Integer;
  ...
  published
    ...
    property ValueWordWrap: string write SetValueWordWrap;
    property OriginalValue: string read GetOriginalValue write FriginalValue;
    property TextColor: TColor read FTextColor write SetTextColor default clDefault;
    property Transparent: Boolean read FTransparent write SetTransparent default True;
    property WordWrap: Boolean read FWordWrap write SetWordWrap default False;
    property CutWasted: Boolean read FCutWasted write FCutWasted;
  end;
  ...
  private
    ...
    FTextBounds: array[0..dxMaxItemsTexts] of TRect;   //dorofeev
  ...
  protected
    ...
    procedure DrawCheckedFrame(const ACanvas: TcxCanvas); virtual; // dorofeev 27.01
...
TTileButtonState = (bsUp, bsDisabled, bsDown, bsExclusive);
  ...
  private
    ...
    FTexts: array [0 .. dxMaxItemsTexts] of TdxTileControlItemText; // Dorofeev 20.01.2020
    FViewData: TdxTileControlCustomItemViewData;
    FVisible: Boolean;
    FTag2, FTag3, FTag4, FTag5, FTag6, FTag7, FTag8, FTag9, FTag10: Integer; // Dorofeev 10.03.2020
    FTextTag1, FTextTag2, FTextTag3, FTextTag4, FTextTag5: string; // Dorofeev 10.03.2020
  ...
  public
    ...
    property Text5: TdxTileControlItemText index 4 read GetText write SetText; // Dorofeev 20.01.2020
    property Text6: TdxTileControlItemText index 5 read GetText write SetText; // Dorofeev 20.01.2020
    property Text7: TdxTileControlItemText index 6 read GetText write SetText; // Dorofeev 20.01.2020
    property Text8: TdxTileControlItemText index 7 read GetText write SetText; // Dorofeev 20.01.2020
    property Text9: TdxTileControlItemText index 8 read GetText write SetText; // Dorofeev 20.01.2020
    property Text10: TdxTileControlItemText index 9 read GetText write SetText; // Demyantsev 18.02.2020

    property Text11: TdxTileControlItemText index 10 read GetText write SetText; // Dorofeev 20.02.2020
    property Text12: TdxTileControlItemText index 11 read GetText write SetText; // Dorofeev 20.02.2020
    property Text13: TdxTileControlItemText index 12 read GetText write SetText; // Dorofeev 20.02.2020
    property Text14: TdxTileControlItemText index 13 read GetText write SetText; // Dorofeev 20.02.2020
    property Text15: TdxTileControlItemText index 14 read GetText write SetText; // Dorofeev 20.02.2020
    property Text16: TdxTileControlItemText index 15 read GetText write SetText; // Dorofeev 20.02.2020
    property Text17: TdxTileControlItemText index 16 read GetText write SetText; // Dorofeev 20.02.2020
    property Text18: TdxTileControlItemText index 17 read GetText write SetText; // Dorofeev 20.02.2020
    property Text19: TdxTileControlItemText index 18 read GetText write SetText; // Dorofeev 20.02.2020
    property Text20: TdxTileControlItemText index 19 read GetText write SetText; // Dorofeev 20.02.2020
    property Texts[Aindex: integer]: TdxTileControlItemText read GetText write SetText;

    property Tag2: Integer read FTag2 write FTag2;
    property Tag3: Integer read FTag3 write FTag3;
    property Tag4: Integer read FTag4 write FTag4;
    property Tag5: Integer read FTag5 write FTag5;
    property Tag6: Integer read FTag6 write FTag6;
    property Tag7: Integer read FTag7 write FTag7;
    property Tag8: Integer read FTag8 write FTag8;
    property Tag9: Integer read FTag9 write FTag9;
    property Tag10: Integer read FTag10 write FTag10;

    property TextTag1: string read FTextTag1 write FTextTag1;
    property TextTag2: string read FTextTag2 write FTextTag2;
    property TextTag3: string read FTextTag3 write FTextTag3;
    property TextTag4: string read FTextTag4 write FTextTag4;
    property TextTag5: string read FTextTag5 write FTextTag5;
  ...
  TOnClickItemProc = procedure(Sender: TdxTileControlItem) of object; // dorofeev 07.02.2020


  TdxTileControlItem = class(TdxTileControlCustomItem, IcxStoredObject, IcxImageCollectionListener)
  private
    FDownedEffect: Boolean; // dorofeev 05.03.2020
    FActiveFrameIndex: Integer;
    FActiveTransitions: TcxObjectList;
    FAnimationInterval: Integer;
    FAnimationMode: TdxDrawAnimationMode;
    FOnClickItemProc: TOnClickItemProc; // dorofeev 07.02.2020
    FWidthOnce: Integer; // dorofeev 05.11.2020
    ...
    FIsActive: Boolean;
    FnotCheckPay:Boolean;
    FRowCount: Integer;
    FRowCountAtLoaded: Integer;
    FSize: TdxTileControlItemSize;
    FViewInfo: TdxTileControlItemViewInfo;
    FCustomSize: Boolean; // dorofeev 12.12.2019
    FWidth: Integer; // dorofeev 12.12.2019
    FHeight: Integer; // dorofeev 12.12.2019
    FOnlySortSeason: Boolean; // dorofeev 22.01.2020
    FCheck: Boolean; // dorofeev 09.05.2020
    FGlyphColor: TColor;
    FCustomBorderColor: TColor;
    FCustomBorderWidth: integer; // putikov 10.04.2020
    ...
    ///<summary>Индекс группы, свойство копирует свойство GroupIndex у TSpeedButton</summary>
    FRadioGroupIndex: integer;
    ///<summary>свойство копирует аналогичное свойство у TSpeedButton.
    /// утопленная кнопка "отжимается" только тогда, когда происходит нажатие
    /// на одну из кнопок, входящих в ту же группу (т.е. свойства AllowAllUp которых равны</summary>
    FAllowAllUp: Boolean;
    FDown: Boolean;
    FDownStateColor: TColor;
    FUpStateColor: TColor;
    FVisibleOnce: Boolean; // dorofeev 09.11.2020
    FTexts: TList<TdxTileControlItemText>;
    FUseAmazingGlyphColor: Boolean;
    FCheckedEnabled: Boolean;
    FUniqGroupingIndex: Integer;
    FLogicState: TStateItemLogic;
    procedure DoAddsText;
    ...
    function GetWidthOnce: Integer;
    procedure SetWidthOnce(const Value: Integer);
    procedure SetVisibleOnce(const Value: Boolean);
    function GetGlyphColor: TColor;
    procedure SetGlyphColor(const Value: TColor);
    procedure ChangeGlyphColor(const Value: TColor);
    procedure DoChangeLogicChecked;
    procedure DoChangeMultiLogicChecked;
    property GroupLayout: TdxTileControlGroupLayout read GetGroupLayout;
    procedure UpdateExclusive;
    procedure SetAllowAllUp(Value: Boolean);
    procedure SetRadioGroupIndex(Value: Integer);
    procedure SetDown(Value: Boolean);
    procedure RepaintItems;
    procedure Pressed(Group: Integer; TileControlItem: TdxTileControlItem);
  protected
    FState: TTileButtonState;
    function TextCut(const AValue: string): string;
  ...
  public
    ...
    property CustomizationSize: Boolean read FCustomSize write FCustomSize; // dorofeev 12.12.2019
    property OnlySortSeason: Boolean read FOnlySortSeason write FOnlySortSeason; // dorofeev 22.01.2020
    property Width: Integer read FWidth write FWidth; // dorofeev 12.12.2019
    property Height: Integer read FHeight write FHeight; // dorofeev 12.12.2019
    property CustomBorderColor: Tcolor read FCustomBorderColor write FCustomBorderColor; // demyantsev 22.01.2020
    property CustomBorderWidth: integer read FCustomBorderWidth write FCustomBorderWidth; // putikov 10.04.2020
    ...
    property OnClickItemProc: TOnClickItemProc read FOnClickItemProc write FOnClickItemProc; // dorofeev 07.02.2020
    property DownedEffect: Boolean Read FDownedEffect write FDownedEffect default False; // dorofeev 05.03.2020
    property Check: Boolean Read FCheck write SetCheck; // dorofeev 09.05.2020
    property WidthOnce: Integer read GetWidthOnce write SetWidthOnce;
    property VisibleOnce: Boolean read FVisibleOnce write SetVisibleOnce;
    property Texts: TList<TdxTileControlItemText> read FTexts write FTexts; //Collection of text (dorofeev 02.01.2020)
    public var VirtualItems: TList<Integer>; // Список Id у сгруппированного Items (dorofeev 02.01.2020)
    public var Strings: TStringList; // Список Id у сгруппированного Items (dorofeev 02.01.2020)
    property UseAmazingGlyphColor: Boolean read FUseAmazingGlyphColor write FUseAmazingGlyphColor; // использование Glypt без картинки, а только передавая цвет. Работает в паре с GlyphColor(dorofeev 04/03/2021)
    property GlyphColor: TColor read GetGlyphColor write SetGlyphColor;
  published
    ...
    property notCheckPay : Boolean read FnotCheckPay write FnotCheckPay;
    ...
    property RadioGroupIndex: Integer read FRadioGroupIndex write SetRadioGroupIndex default 0;
    property Down: Boolean read FDown write SetDown default False;
    property DownStateColor: TColor read FDownStateColor write FDownStateColor default clDefault;
    property UpStateColor: TColor read FUpStateColor write FUpStateColor default clDefault;
    property CheckedEnabled: Boolean read FCheckedEnabled write FCheckedEnabled;
    property UniqGroupingIndex: Integer read FUniqGroupingIndex write FUniqGroupingIndex;
    property LogicState: TStateItemLogic read FLogicState write FLogicState;
  end;
...
//    function AddDefRender: TdxTileControlItem;
  ...
  private
    FRectGroup: TTileClickedRect;
    FIsHidest: Boolean; // dorofeev 15.12
    FCaption: TdxTileControlGroupCaption;
    FCustomSize: Boolean; // dorofeev 15.12
    FWidth: Integer; // dorofeev 15.12
    FShowContent: Boolean; // dorofeev 09.01
    ...
    FOnGetStoredPropertyValue: TcxGetStoredPropertyValueEvent;
    FOnSetStoredPropertyValue: TcxSetStoredPropertyValueEvent;
    FDoubleTitle: Boolean;
    FOnItemsClick: TdxTileControlItemEvent;
    function GetBounds: TRect;
    ...
    procedure IcxStoredParent.DeleteChild = StoredDeleteChild;
    procedure IcxStoredParent.GetChildren = StoredChildren;
    function GetShowContent: Boolean;
    property GroupLayout: TdxTileControlGroupLayout read GetGroupLayout;
  protected
    ...
    procedure CheckLogicControl(const AGroupingIndex: Integer);
    // IcxStoredObject
    function GetObjectName: string;
    function GetProperties(AProperties: TStrings): Boolean; virtual;
    procedure GetPropertyValue(const AName: string; var AValue: Variant); virtual;
  ...
  public
    ...
    function AddItem(ALogicState: TStateItemLogic; AGroupingIndex: Integer; AFontSize: Integer
                      ; AText: string;  AFontStyle: TFontStyles): TdxTileControlItem; overload;

    function AddItem(ASpecificItem: TdxTileControlItem
                ; ALogicState: TStateItemLogic; AGroupingIndex: Integer
             ; AFontSize: Integer; AText: string;  AFontStyle: TFontStyles): TdxTileControlItem; overload;

    function AddItem(ALogicState: TStateItemLogic; AGroupingIndex: Integer; AFontSize: Integer
                      ; AText1: string;  AFontStyle1: TFontStyles
                      ; AText2: string;  AFontStyle2: TFontStyles
                      ): TdxTileControlItem; overload;

    function AddItem(ASpecificItem: TdxTileControlItem
                    ;ALogicState: TStateItemLogic
                    ; AGroupingIndex, AFontSize: Integer
                    ; AText1: string; AFontStyle1: TFontStyles
                    ; AText2: string; AFontStyle2: TFontStyles): TdxTileControlItem; overload;
    ...
    property RectGroup: TTileClickedRect read FRectGroup write FRectGroup;
    property Groups: TdxTileControlGroupCollection read GetGroups;
    ...
    property Width: Integer read FWidth write FWidth; // dorofeev 12.12.2019
    property CustomizationSize: Boolean read FCustomSize write FCustomSize; // dorofeev 12.12.2019
    property ShowContent: Boolean read GetShowContent; // dorofeev 25.01.2021
    property OnItemsClick: TdxTileControlItemEvent read FOnItemsClick write FOnItemsClick;
  published
    ...
    property Visible: Boolean read FVisible write SetVisible default True;
    property Index;
    property DoubleTitle: Boolean read FDoubleTitle write FDoubleTitle; // dorofeev 25.01.2021
    // IcxStoredObject events
  ...
  private
    ...
    procedure SetAlignment(AValue: TAlignment);
    procedure SetColor(AValue: TColor);
    procedure SetText1Font(AValue: TFont);
    procedure SetText2Font(AValue: TFont);
  ...
  published
    ...
    property Alignment: TAlignment read FAlignment write SetAlignment default taLeftJustify;
    property Font: TFont read FFont write SetFont stored IsFontStored;
    property Text1Font: TFont read FText1Font write SetText1Font stored IsFontStored;
    property Text2Font: TFont read FText2Font write SetText2Font stored IsFontStored;
  ...
  protected
    procedure Changed; virtual;
    procedure DefineProperties(Filer: TFiler); override;
    function GetActualGroupIndent: Integer;
    function GetActualIndentHorz: Integer;
    function GetActualIndentVert: Integer;
    function GetActualItemHeight: Integer;
    function GetActualItemIndent: Integer;
    function GetActualItemWidth: Integer;
    ...
    function ItemIndentStored: Boolean;
    function ItemWidthStored: Boolean;
  ...
  published
    ...
    property ItemIndent: Integer read FItemIndent write SetItemIndent stored ItemIndentStored;
    property ItemWidth: Integer read FItemWidth write SetItemWidth stored ItemWidthStored;
  end;
  ...
  public
    ...
    procedure DrawGlyph(ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState;
      AGlyph: TdxSkinImage; AGlyphType: TImageType; AColor: TColor); virtual;
  ...
  TdxCustomTileControl = class(TcxControl, IcxStoredParent, IcxStoredObject, IdxSkinSupport)
  private
    FCheckedFrameRect: TRect; // dorofeev 04.03.2020 (область рисования квадрата для Checked)
    FCheckBoxPosition: TdxTileItemInnerObjectAlignment;   // putikov - положение чекбокса на элементе
    FUseAmazingGroup: Boolean; // dorofeev 19.12
    FRoundRectRatio: Integer; // dorofeev 21.01.2020
    FCustomTag: Integer;
    FUseAmazingRoundRect: Boolean; // dorofeev 21.01.2020
    ...
    procedure SetTransparent(AValue: Boolean);
    function GetOnceChecked: Boolean; // dorofeev 24.12
    // scroll
    ...
    procedure SetAmazingGroup(AUse: Boolean);
    procedure SetCustomTag(const Value: Integer);
    procedure SaveChangeState;
  ...
  public
    ...
    procedure SetImgToGroup(const APath: string); // dorofeev 19.12.2019
    ...
    property UseAmazingGroup: Boolean read FUseAmazingGroup write SetAmazingGroup; // dorofeev 19.12
    property IsOnceChecked: Boolean read GetOnceChecked; // dorofeev 24.12
    property RoundRectRatio: Integer read FRoundRectRatio write FRoundRectRatio; // dorofeev 21.01.2020
    property UseAmazingRoundRect: Boolean read FUseAmazingRoundRect write FUseAmazingRoundRect; // dorofeev 21.01.2020
    property CheckedFrameRect: TRect read FCheckedFrameRect; // dorofeev 04.03.2020 (область рисования квадрата для Checked)
    property CheckBoxPosition: TdxTileItemInnerObjectAlignment read FCheckBoxPosition write FCheckBoxPosition;  // dputikov 09.04.2020
    property CustomTag: Integer read FCustomTag write SetCustomTag default 0;
    public var VirtualItems: TList<Integer>; // Список Id у сгруппированного Items (dorofeev 02.01.2020)
...
uses
  dxOffice11, RTLConsts, Variants, cxTextEdit;
...
const
  DefaultFontName: string = 'Segoe UI'; // общий шрифт для всех TileControl
...
constructor TTileClickedRect.Create(AOwner: TComponent);
begin
...
destructor TTileClickedRect.Destroy;
begin
  CanvasBufer.Free;
  inherited;
end;

procedure TTileClickedRect.MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
  i: Integer;
begin
  inherited;
  try
    FClick := not FClick;
    FOwnerGroup.FIsHidest := not FClick;

    for i := 0 to FOwnerGroup.ItemCount - 1 do
      FOwnerGroup.Items[i].Visible := FClick;

    FOwnerGroup.FShowContent := FClick;
  finally
    FOwnerGroup.TileControl.Repaint;
  end;
end;

procedure TTileClickedRect.Paint;
var
  Rect: TRect;
begin
  if FSavePaint then
  begin
    Rect := Bounds(self.Width, 0, self.Width, self.Height);
    Canvas.CopyRect(Rect, CanvasBufer.Canvas, Rect);
  end else
    inherited;
end;

procedure TTileClickedRect.ResetCanvas;
begin
  FSavePaint := False;
  Repaint;
end;

procedure TTileClickedRect.SaveCanvas;
var
  Rect: TRect;
begin
  Rect := Bounds(0, 0, self.Width, self.Height);
  CanvasBufer.Width := self.Width;
  CanvasBufer.Height := self.Height;
  CanvasBufer.Canvas.CopyRect(Rect, self.Canvas, Rect);
  FSavePaint := True;
end;
...
function GetActualFocusItemFrameSize(const ASize: Integer): Integer;
begin
  Result := cxGetValueCurrentDPI(ASize);
end;
...
var
  ...
  DefaultPenColor, DefaultPenWidth: integer;
//  p1, p2: TPoint;
begin
  ValidateCache(ADrawRect);
  cxBitBlt(ACanvas.Handle, Cache.Canvas.Handle, ADrawRect, cxNullPoint, SRCCOPY);

  if (TileControl.FUseAmazingRoundRect) then begin
    GradientColor := TileControl.Style.GradientBeginColor;

    if (GradientColor = clDefault) then
      GradientColor := clWhite;

    ACanvas.Pen.Color := GradientColor;
    ACanvas.Brush.Style := bsClear;

    for I := 0 to TileControl.FRoundRectRatio do
      ACanvas.RoundRect(ADrawRect, I, I);

   if (Item.FCustomBorderColor <> clDefault) then
    begin
      DefaultPenColor := ACanvas.Pen.Color;
      DefaultPenWidth := ACanvas.Pen.Width;
      ACanvas.Pen.Width := Item.FCustomBorderWidth;
      ACanvas.Pen.Color := Item.FCustomBorderColor;
      ACanvas.RoundRect(ADrawRect, TileControl.FRoundRectRatio + 1, TileControl.FRoundRectRatio + 1);
      ACanvas.Pen.Color := DefaultPenColor;
      ACanvas.Pen.Width := DefaultPenWidth;
    end;
  end;
end;
...
begin
  ...
  try
    ...
    if not AIsOuter then
      ...
      ACanvas.ExcludeClipRect(cxRectInflate(R, -cxGetValueCurrentDPI(2)));
...
var
  R: TRect;
begin
  R := cxRectInflate(Bounds, InflateDelta);
  dxGpFillRect(ACanvas.Handle, R, Painter.SelectionSelectedColor, 127);
...
begin
  ...
  if (Item = Controller.HottrackedItem) and (AOptionsBehavior.ItemHotTrackMode in [tcihtmFrame, tcihtmOuterFrame]) then
    if AOptionsBehavior.ItemHotTrackMode = tcihtmOuterFrame then
      Result := GetActualFocusItemFrameSize(dxTileFocusItemOuterFrameSize)
    else
      Result := GetActualFocusItemFrameSize(dxTileFocusItemFrameSize);

  if Focused and (AOptionsBehavior.ItemFocusMode = tcifmOuterFrame) then
      Result := Max(Result, GetActualFocusItemFrameSize(dxTileFocusItemOuterFrameSize))
    else
      Result := Max(Result, GetActualFocusItemFrameSize(dxTileFocusItemFrameSize));
end;
...
begin
  ARegularItemWidth := TileControl.OptionsView.GetActualItemWidth;
...
var
  ...
  k, m, t, h: Integer;
begin
  if not Item.FCustomSize then begin
    ARegularItemHeight := TileControl.OptionsView.GetActualItemHeight;
  end
  else begin
    if Item.FOnlySortSeason then
      Item.TileControl.OptionsView.ItemHeight := Item.FHeight;
    ARegularItemHeight := Item.FHeight;
  end;


  // FOnlySortSeason = True  настройка говорит о том что используется группировка в HallTile


   AItemIndent := ItemIndent;
{   ASize := Item.Size;
  // ARow := Item.ViewInfo.Position.Row;

   if not Item.FOnlySortSeason then begin
     if (Item.FCustomSize) then begin
      Item.Size := tcisSmall;
     // ARow := Item.ViewInfo.Position.Row-1;
     end;

    if not (Item.FCustomSize) then  begin
      Item.Size := tcisRegular;
    //  ARow := Item.ViewInfo.Position.Row -1;
    end;
   end else Item.Size := ASize;   }

//   if not (Item.FCustomSize) then Item.Size := ASize;
  // Item.ViewInfo.Position.Row := ARow;

   k := (Position.Row div 2)  ; // top (Положение всех Items относительно вверх/вниз)

   m := (ARegularItemHeight + AItemIndent); // Real Indent
   t := Item.Group.Bounds.Top;
   h := Item.Group.Caption.Height;
...
//    begin
      if Item.FCustomSize then
        ...
        Result := TileControl.OptionsView.GetActualItemWidth;
//    end
  else
...
begin
  Result := TileControl.OptionsView.GetActualItemIndent;
end;
...
//  ARegularItemHeight := TileControl.OptionsView.GetActualItemHeight;
  AItemIndent := TileControl.OptionsView.GetActualItemIndent;
...
begin
  AGroupIndent := TileControl.OptionsView.GetActualGroupIndent;
  ABorderWidth := TdxTileControlGroupViewInfo.GetActualBorderWidth;
  ...
  if ((Self = Group.VirtualGroupBefore) and Group.IsMostLeft) or
    ...
    AWidth := WeightOutermostGroup(TileControl.OptionsView.GetActualIndentHorz - ABorderWidth);
...
begin
  ...
  if (Group.ShowContent) then
    AHeight := AGroupIndent + Group.GetCustomIndent(Self) // def
  else
    if (Group.DoubleTitle) then
      AHeight := AGroupIndent + Group.GetCustomIndent(Self) - TileControl.OptionsView.ItemHeight
    else
      AHeight := AGroupIndent + Group.GetCustomIndent(Self) - (TileControl.OptionsView.ItemHeight);

  if ((Self = Group.VirtualGroupBefore) and Group.IsMostLeft) or
     ((Self = Group.VirtualGroupAfter) and Group.IsMostRight) then
    AHeight := HeightOutermostGroup(TileControl.OptionsView.GetActualIndentVert - ABorderWidth);
...
begin
  ...
  ALeft := Max(AItemIndent, TileControl.OptionsView.GetActualIndentHorz - AItemIndent);
...
begin
  ...
  if Group.Visible then
    if (Self = Group.VirtualGroupAfter) and (GroupLayout = glHorizontal) then
      Result := Group.ViewInfo.ItemsRight - TdxTileControlGroupViewInfo.GetActualBorderWidth
    else
    begin
      Result := TileControl.ViewInfo.TilesArea.Left - TileControl.ViewInfo.LeftScrollPos;
      if TileControl.OptionsView.FixedIndentHorz then
        Dec(Result, TileControl.OptionsView.GetActualIndentHorz);
    end;
end;
...
begin
  ...
  if Group.Visible and (GroupLayout = glVertical) then
    ...
    begin
      ...
      if TileControl.OptionsView.FixedIndentVert then
        Dec(Result, TileControl.OptionsView.GetActualIndentVert);
    end
    else
      Result := Group.ViewInfo.ItemsBottom - TdxTileControlGroupViewInfo.GetActualBorderWidth;
end;
...
begin
  inherited CalculateSize(AWidth, AHeight);
  if not Group.Visible then Exit;
  AItemHeight := TileControl.OptionsView.GetActualItemHeight;

  if Group.FCustomSize then
    AItemWidth := Group.FWidth
  else
    AItemWidth := TileControl.OptionsView.GetActualItemWidth;
  ...
  ABorderWidth := GetActualBorderWidth;
...
class function TdxTileControlGroupViewInfo.GetActualBorderWidth: Integer;
begin
  Result := cxGetValueCurrentDPI(dxTileControlSizeGroupBorder);
end;
...
begin
  ...
  begin
    ...
    begin
      Result := TileControl.ViewInfo.TilesArea.Left - TileControl.ViewInfo.LeftScrollPos - GetActualBorderWidth;
      if not TileControl.OptionsView.FixedIndentHorz then
        Inc(Result, TileControl.OptionsView.GetActualIndentHorz);
...
begin
  AItemIndent := TileControl.OptionsView.GetActualItemIndent;
  Result := TileControl.OptionsView.GetActualItemHeight + AItemIndent;
  if GroupLayout = glHorizontal then
...
begin
  AItemIndent := TileControl.OptionsView.GetActualItemIndent;
  Result := TileControl.OptionsView.GetActualItemWidth + AItemIndent;
...
begin
  ...
  if GroupLayout = glHorizontal then
  begin
    Result := TileControl.ViewInfo.TilesArea.Top - TileControl.ViewInfo.TopScrollPos - GetActualBorderWidth;
    if not TileControl.OptionsView.FixedIndentVert then
      Inc(Result, TileControl.OptionsView.GetActualIndentVert);
...
begin
  ...
  begin
    ...
    OffsetRect(FGlyphBounds, -Title.GetActualIndentHorz, -FGlyphBounds.Top div 2);
  end;
end;

procedure TdxTileControlTitleViewInfo.DoCalculateTextBounds;
begin
  FTextBounds.Left := GetTextLeftOffset;
...
begin
  ...
  AIndentVert := Title.GetActualIndentVert;
  if not Title.Glyph.Empty then
...
begin
  Result := TileControl.OptionsView.GetActualIndentHorz;
end;
...
function TdxTileControlItemText.GetActualIndentHorz: Integer;
begin
  Result := cxGetValueCurrentDPI(IndentHorz);
end;

function TdxTileControlItemText.GetActualIndentVert: Integer;
begin
  Result := cxGetValueCurrentDPI(IndentVert);
end;
...
function TdxTileControlItemText.GetOriginalValue: string;
begin
  if (Trim(FriginalValue) > '') then
    Result := FriginalValue
  else
    Result := Value;
end;
...
begin
  ...
  begin
    if (FValue2 <> AValue) and (AValue <> '') then
     FValue2:= AValue;
...
procedure TdxTileControlItemText.SetValueWordWrap(AValue: string);
var
  s, delimText: TStringList;
  c, t: string;
  i, dv: Integer;
begin
  if (Owner.Glyph.ImageId > 0) then
    dv := 18
  else
    dv := 26;
  ...
  delimText := TStringList.Create;
  try
    s.DelimitedText := AValue;
    c := '';
    t := '';
    for I := 0 to s.Count - 1 do      // Блинчики с  мясом и сметаной
    begin
      c := t + s.Strings[i] + ' ';
      if Length(c) > dv then
      begin
        delimText.Add(t); // блинчики с
        t := s.Strings[i] + ' '; // блинчики с мясом
      end else
        t := c;
    end;
   delimText.Add(t);

   Self.FValue := delimText.Text;
  finally
    Changed;
    s.Free;
    delimText.Free;
...
function TdxTileControlItemCustomGlyph.GetActualIndentHorz: Integer;
begin
  Result := cxGetValueCurrentDPI(IndentHorz);
end;

function TdxTileControlItemCustomGlyph.GetActualIndentVert: Integer;
begin
  Result := cxGetValueCurrentDPI(IndentVert);
end;
...
procedure TdxTileControlItemCustomGlyph.SetImage(AValue: TdxSmartImage);
begin
...
begin
  ...
  if AAlign in [itaLeft, itaRight] then
    Inc(R.Right, cxRectWidth(ATextBounds) + AText.GetActualIndentHorz)
  else
    Inc(R.Bottom, cxRectHeight(ATextBounds) + AText.GetActualIndentVert);
  AdjustObjectBounds(ABounds, R, AImageAlign, AGlyph.GetActualIndentHorz, AGlyph.GetActualIndentVert);
  //
  case AAlign of
    itaLeft:
    begin
      AImageBounds := cxRectSetLeft(AImageBounds, R.Left);
      ATextBounds := cxRectSetLeft(ATextBounds,  AImageBounds.Right + AText.GetActualIndentHorz);
    end;
    itaTop:
    begin
      AImageBounds := cxRectSetTop(AImageBounds, R.Top);
      ATextBounds := cxRectSetTop(ATextBounds,  AImageBounds.Bottom + AText.GetActualIndentVert);
    end;
    itaRight:
    begin
      AImageBounds := cxRectSetRight(AImageBounds, R.Right);
      ATextBounds := cxRectSetRight(ATextBounds,  AImageBounds.Left - AText.GetActualIndentHorz);
    end;
    itaBottom:
    begin
      AImageBounds := cxRectSetBottom(AImageBounds, R.Bottom);
      ATextBounds := cxRectSetBottom(ATextBounds,  AImageBounds.Top - AText.GetActualIndentVert);
    end;
  end;
...
procedure TdxTileControlCustomItemViewData.CalculateImageAndTextLayout(const ABounds: TRect);
  ...
  begin
    Result := ABounds;
    Result.BottomRight := cxPointOffset(Result.BottomRight, -AText.GetActualIndentHorz, -AText.GetActualIndentVert);
    ...
    begin
      ...
      if AImageAlign in [itaLeft, itaRight] then
        Dec(Result.Right, AImageSize.cx + AGlyph.GetActualIndentHorz)
      else
        Dec(Result.Bottom, AImageSize.cy + AGlyph.GetActualIndentVert);
    end;
  end;
...
begin
  ...
  if (not AGlyph.Image.Empty or AGlyph.IsImagesUse) and (cxRectWidth(ABounds) - cxRectWidth(FImageBounds) > 3) then
    FImageBounds := AGlyph.GetClientRect(ABounds);
  for I := 0 to dxMaxItemsTexts do         //dorofeev
  begin
    ...
    AdjustObjectBounds(ABounds, FTextBounds[I], AText.GetActualAlign, AText.GetActualIndentHorz, AText.GetActualIndentVert);
  end;
  if not cxRectIsEmpty(FImageBounds) then
  begin
    AdjustObjectBounds(ABounds, FImageBounds, AGlyph.GetActualAlign, AGlyph.GetActualIndentHorz, AGlyph.GetActualIndentVert);
...
procedure TdxTileControlCustomItemViewData.DrawCheckedFrame(const ACanvas: TcxCanvas);
var
  r: TRect;
begin
  case TileItem.TileControl.CheckBoxPosition of
    oaTopLeft:
      begin
        r.Top := 7;
        r.Left := 7;
    ...
    oaTopCenter:
      begin
        r.Top := 7;
        r.Left := (TileItem.TileControl.OptionsView.ItemWidth - 15) div 2;
      end;
    oaTopRight:
      begin
        r.Top := 7;
        r.Left := TileItem.TileControl.OptionsView.ItemWidth - 15 - 7;
      end;
    oaMiddleLeft, oaDefault:
      begin
        r.Top := (TileItem.TileControl.OptionsView.ItemHeight - 15) div 2;
        r.Left := 7;
      end;
    oaMiddleCenter:
      begin
    ...
    oaBottomLeft:
      begin
        r.Top := TileItem.TileControl.OptionsView.ItemHeight - 15 - 7;
        r.Left := 7;
      end;
    oaBottomCenter:
      begin
  ...
  if (TileItem.CheckedEnabled) then
  begin
    ACanvas.Pen.Width := 1;
    ACanvas.Brush.Style := bsClear;
    ACanvas.Pen.Color := RGB(46, 146, 214);
    ACanvas.RoundRect(r, 6, 6);
  end ;
{  else begin
    ACanvas.Pen.Width := 1;
    ACanvas.Brush.Style := bsClear;
    ...
    begin
      r.Width := i;
      r.Height := i;
      ACanvas.Pen.Color := RGB(202, 227, 255);
      ACanvas.RoundRect(r, 6, 6);
    end;  }

  Item.TileItem.TileControl.FCheckedFrameRect := r;
end;
...
begin
  ...
  if Item.TileItem.TileControl.OptionsBehavior.ItemCheckMode = tcicmMultiple then
    DrawCheckedFrame(ACanvas);
end;
...
begin
  AGlyph := Item.Glyph;
  if not AGlyph.Image.Empty then
    AGlyph.Image.StretchDraw(ACanvas.Handle, ImageBounds)
  else
    if AGlyph.IsImagesUse then
      cxDrawImage(ACanvas.Handle, ImageBounds, Bounds, nil, AGlyph.GetImages, AGlyph.ImageIndex, idmNormal,
        True, 0, clNone, False);
end;
...
begin
  ...
  begin
    ...
    // dorofeev
    Text5 := ACustomItem.Text5;
    Text6 := ACustomItem.Text6;
    Text7 := ACustomItem.Text7;
    Text8 := ACustomItem.Text8;
    Text9 := ACustomItem.Text9;
    Text10 := ACustomItem.Text10;
...
function TdxTileControlItem.TextCut(const AValue: string): string;
begin
  Result := AValue;

  case LogicState of
    itlMain, itlMultiMain:
    begin
      if Length(AValue) > 18 then
        Result := Copy(AValue, 0, 18) + '..';
    end;
    itlChild:
    begin
      if Length(AValue) > 25 then
        Result := Copy(AValue, 0, 25) + '..';
    end;
    Else
      Exit;
  end;
...
var
  ...
  R: TRect;
begin
  AColumnWidth := TileControl.OptionsView.GetActualItemWidth div AColumnCountPerRegularItem;
  ARowHeight := TileControl.OptionsView.GetActualItemHeight div ARowCountPerRegularItem;
  R := CellsBounds;
...
begin
  inherited Create(AOwner);
  VirtualItems := TList<Integer>.Create; // dorofeev 02.01.2020
  Strings := TStringList.Create;
  FDownedEffect := False;
  FCheck := False;
  notCheckPay := False; // demyantsev 13.09.2020 PREM-290 добавил флаг, будет информировать о необходимости проверки наличия оплат при нажатиях на кнопки меню кассы(верхние панели).
  FCustomSize := False; // dorofeev 12.12.2019
  FWidth := 200; // def // dorofeev 12.12.2019
  FHeight := 80; // def // dorofeev 12.12.2019
  FOnlySortSeason := False; // def // dorofeev 22.01.2020
  FCustomBorderColor := clDefault; //22.01.2020 def // demyantsev
  FCustomBorderWidth := 1;  // putikov 10.04.2020
  FUseAmazingGlyphColor := False;
  FActiveTransitions := TcxObjectList.Create;
  FFrames := CreateFrames;
  FCheckedEnabled := True;
  ...
  FSize := tcisRegular;
  FTexts := TList<TdxTileControlItemText>.Create;
  FUniqGroupingIndex := -1;
  FLogicState := itlNone;
  DoAddsText;
end;
...
procedure TdxTileControlItem.ChangeGlyphColor(const Value: TColor);
var
  jpg: TJPEGImage;
  img: TImage;
begin
  ...
  try
    ...
    img.Picture.Bitmap.Canvas.Brush.Color := Value;
    img.Picture.Bitmap.Canvas.RoundRect(0, 0, 20, 20, 15, 15);
    img.Picture.Graphic.SetSize(20, 20);
    jpg.Assign(img.Picture.Graphic);
    Glyph.IndentVert := 15;
    Glyph.IndentHorz := 15;
    Glyph.Align := oaMiddleLeft;
    Glyph.Image.Assign(jpg);
  finally
    jpg.Free;
    img.Free;
  end;
...
procedure TdxTileControlItem.DoChangeLogicChecked;

  procedure ClearAll;
  var
    i, j: Integer;
  begin
      for i := 0 to Pred(Self.TileControl.Items.Count) do
        if Self.TileControl.Items[i].LogicState <> itlNone then
        begin
          Self.TileControl.Items[i].Style.BorderColor := clWhite;
          Self.TileControl.Items[i].Style.GradientBeginColor := clWhite;
          Self.TileControl.Items[i].Style.GradientEndColor := clWhite;
          Self.TileControl.Items[i].FChecked := False;
          for j := 0 to Self.Texts.Count - 1 do
            Self.TileControl.Items[i].Texts[j].TextColor := clBlack;
        end;
  end;

  procedure DrawItem(AItemColor, ATextColor: TColor);
  var
    i: Integer;
  begin
    ClearAll;
    Self.Style.GradientBeginColor := AItemColor;
    Self.Style.GradientEndColor := AItemColor;
    Self.Style.BorderColor := AItemColor;
    for I := 0 to Self.Texts.Count - 1 do
      Self.Texts[i].TextColor := ATextColor;
  end;

  procedure DrawItems(AItemColor, ATextColor: TColor);
  var
    i, j: Integer;
  begin
    ClearAll;
    for i := 0 to Pred(Self.TileControl.Items.Count) do
      if (Self.TileControl.Items[i].UniqGroupingIndex > -1)
      and (Self.TileControl.Items[i].UniqGroupingIndex = Self.UniqGroupingIndex)
      and (Self.TileControl.Items[i].Group.ID = Self.Group.ID) then
      begin
        Self.TileControl.Items[i].Style.BorderColor := AItemColor;
        Self.TileControl.Items[i].Style.GradientBeginColor := AItemColor;
        Self.TileControl.Items[i].Style.GradientEndColor := AItemColor;
        for j := 0 to  Self.Texts.Count - 1 do
          Self.TileControl.Items[i].Texts[j].TextColor := ATextColor;
      end;
  end;


   function GetCheckCountItemsInLogicMain: Integer;
   var
     i, k: Integer;
   begin
    k := 0;
     for i := 0 to Pred(Self.TileControl.Items.Count) do
       if (Self.TileControl.Items[i].UniqGroupingIndex > -1)
       and (Self.TileControl.Items[i].UniqGroupingIndex = Self.UniqGroupingIndex)
       and (Self.TileControl.Items[i].Group.ID = Self.Group.ID)
       and (Self.TileControl.Items[i].Checked)
       and (Self.TileControl.Items[i].LogicState = itlMain)
       and (Self.TileControl.Items[i].ID <> Self.ID)then
        Inc(k);
     result := k;
   end;

   function GetRealCheckItem: Boolean;
   var
     m: Integer;
   begin
     Result := False;
     m := GetCheckCountItemsInLogicMain;

     if (Self.LogicState = itlMain) then
         Result := (m = 0) and FChecked;

     if (Self.LogicState = itlChild) then
         Result := FChecked;
   end;
...
var
  ...
  rch: Boolean;
begin
  rch := GetRealCheckItem;
  f := rch;
  try
    case LogicState of
      itlMain:
        if rch then
          DrawItems(cPrimeraSelectedColor, clWhite)
        else
          DrawItems(clWhite, clBlack);
      itlChild:
        if rch then
          DrawItem(cPrimeraSelectedColor, clWhite)
        else
          DrawItem(clWhite, clBlack);
    else
      Exit;
    end;
  finally
...
procedure TdxTileControlItem.DoChangeMultiLogicChecked;
  procedure DrawItems(AItemColor, ATextColor: TColor; Check:boolean);
  var
    i, j: Integer;
  begin
    for i := 0 to Pred(Self.TileControl.Items.Count) do
      if (Self.TileControl.Items[i].UniqGroupingIndex > -1)
        and (Self.TileControl.Items[i].UniqGroupingIndex = Self.UniqGroupingIndex)
        and (Self.TileControl.Items[i].Group.ID = Self.Group.ID)
        and (Self.TileControl.Items[i].LogicState = itlMultiMain)then
     begin
        Self.TileControl.Items[i].Style.BorderColor := AItemColor;
        Self.TileControl.Items[i].Style.GradientBeginColor := AItemColor;
        Self.TileControl.Items[i].Style.GradientEndColor := AItemColor;
        Self.TileControl.Items[i].FChecked:=Check;
        for j := 0 to  Self.Texts.Count - 1 do
          Self.TileControl.Items[i].Texts[j].TextColor := ATextColor;
      end;
  end;
...
begin
  case LogicState of
    itlMultiMain:
      if FChecked then
        DrawItems(cPrimeraSelectedColor, clWhite, true)
      else
        DrawItems(clWhite, clBlack, false);
  else
    Exit;
  end;
end;
...
procedure TdxTileControlItem.DoAddsText;
begin
  FTexts.Add(Text1);
  FTexts.Add(Text2);
  FTexts.Add(Text3);
...
procedure TdxTileControlItem.RepaintItems;
var
  i: Integer;
begin
  for I := 0 to Group.ItemCount - 1 do
    if Group.Items[I] is TdxTileControlItem then
      begin
        if TdxTileControlItem(Group.Items[I]).Down and
        (TdxTileControlItem(Group.Items[I]).RadioGroupIndex <> 0)
         then
          begin
            TdxTileControlItem(Group.Items[I]).Style.GradientBeginColor := DownStateColor;
            TdxTileControlItem(Group.Items[I]).Style.GradientEndColor := DownStateColor;
          end
        else
          begin
            TdxTileControlItem(Group.Items[I]).Style.GradientBeginColor := UpStateColor;
            TdxTileControlItem(Group.Items[I]).Style.GradientEndColor := UpStateColor;
          end;
      end;
end;
...
function TdxTileControlItem.GetGlyphColor: TColor;
begin
  Result := FGlyphColor;
end;
...
function TdxTileControlItem.GetWidthOnce: Integer;
begin
  Result := FWidthOnce;
end;
...
procedure TdxTileControlItem.SetCheck(const Value: Boolean);
begin
  if Value then
  begin
    Style.GradientBeginColor := $003CB850;
    Style.GradientEndColor := $003CB850;
  ...
  begin
    ...
    begin
      ...
      Controller.ItemChecked(Self);
        case Self.LogicState of
          itlMain, itlChild: DoChangeLogicChecked;
          itlMultiMain: DoChangeMultiLogicChecked;
        else
          Exit;
        end;
    end;
...
procedure TdxTileControlItem.SetGlyphColor(const Value: TColor);
begin
  FGlyphColor := Value;
  if FUseAmazingGlyphColor then
    ChangeGlyphColor(FGlyphColor);
end;
...
procedure TdxTileControlItem.SetGroupDefRender(AValue: TdxTileControlGroup);
begin
  if FGroup <> AValue then
  begin
    TileControl.BeginUpdate;
    try
      ...
      TileControl.EndUpdateDefRender;
    end;
  end;
end;
...
procedure TdxTileControlItem.SetVisibleOnce(const Value: Boolean);
begin
  FVisibleOnce := Value;
  Visible := FVisibleOnce;
  TileControl.Visible := FVisibleOnce;
end;

procedure TdxTileControlItem.SetWidthOnce(const Value: Integer);
begin
  FWidth := Value;
  TileControl.OptionsView.ItemWidth := FWidth;
  TileControl.Width := FWidth + 1;
end;
...
procedure TdxTileControlItem.UpdateExclusive;
var
  I: Integer;
begin
  if (FRadioGroupIndex <> 0) then
  begin
    for I := 0 to Group.ItemCount - 1 do
      if Group.Items[I] is TdxTileControlItem then
        TdxTileControlItem(Group.Items[I]).Pressed(FRadioGroupIndex, Self);
  end;
end;

procedure TdxTileControlItem.Pressed(Group: Integer;
  TileControlItem: TdxTileControlItem);
begin
  if (Group = FRadioGroupIndex) and (TileControlItem <> Self) then
  begin
    if TileControlItem.Down and FDown then
    begin
      FDown := False;
      FState := bsUp;
      RepaintItems;
    ...
    FAllowAllUp := TileControlItem.AllowAllUp;
  end;
end;

procedure TdxTileControlItem.SetAllowAllUp(Value: Boolean);
begin
...
procedure TdxTileControlItem.SetDown(Value: Boolean);
begin
  if FRadioGroupIndex = 0 then Value := False;
  if Value <> FDown then
  begin
...
procedure TdxTileControlItem.SetRadioGroupIndex(Value: Integer);
begin
  if FRadioGroupIndex <> Value then
  begin
    FRadioGroupIndex := Value;
    UpdateExclusive;
  end;
end;
...
{function TdxTileControlItemCollection.AddDefRender: TdxTileControlItem;
begin
  Result := inherited AddDefRender as TdxTileControlItem;
end;}
...
procedure TdxTileControlGroup.CheckLogicControl(const AGroupingIndex: Integer);
var
  i: Integer;
  f: Boolean;
begin
  if (AGroupingIndex = -1) then
    Exit;

  f := False;
  for i := 0 to ItemCount - 1 do
    if (Items[i].UniqGroupingIndex = AGroupingIndex) then
    begin
      f := True;
      Break;
    end;
...
function TdxTileControlGroup.AddItem(ALogicState: TStateItemLogic; AGroupingIndex: Integer
             ; AFontSize: Integer; AText: string;  AFontStyle: TFontStyles): TdxTileControlItem;
var
  AItem: TdxTileControlItem;
begin
  CheckLogicControl(AGroupingIndex);
  AItem := TileControl.Items.Add;
  AItem.UniqGroupingIndex := AGroupingIndex;
  AItem.LogicState := ALogicState;
  if Assigned(OnItemsClick) then
    AItem.OnClick := OnItemsClick;
  AItem.Group := Self;
  AItem.Style.GradientBeginColor := clWhite;
  AItem.Style.GradientEndColor := clWhite;
  AItem.Style.BorderColor := clWhite;
  AItem.Text1.Font.Name := 'Segoe UI';
  AItem.Text1.TextColor := clBlack;
  AItem.Text1.Font.Size := AFontSize;
  AItem.Text1.Font.Style := AFontStyle;
  AItem.Text1.Align := oaTopLeft;
  if (AFontSize = 14) then
    AItem.Text1.IndentVert := -4
  else
    AItem.Text1.IndentVert := -2;
  AItem.Text1.Value := AItem.TextCut(AText);

  Result := AItem;
end;

function TdxTileControlGroup.AddItem(ASpecificItem: TdxTileControlItem; ALogicState: TStateItemLogic
                                ; AGroupingIndex: Integer; AFontSize: Integer; AText: string
                                ; AFontStyle: TFontStyles): TdxTileControlItem;
var
  AItem: TdxTileControlItem;
begin
  CheckLogicControl(AGroupingIndex);
  ...
  AItem.Text1.Value := AItem.TextCut(AText);
  AItem.Tag := ASpecificItem.Tag;
  AItem.Tag2 := ASpecificItem.Tag2;
  AItem.Tag3 := ASpecificItem.Tag3;
  AItem.Tag4 := ASpecificItem.Tag4;
  AItem.Tag5 := ASpecificItem.Tag5;
  AItem.Tag6 := ASpecificItem.Tag6;
  AItem.Tag7 := ASpecificItem.Tag7;
  AItem.Tag8 := ASpecificItem.Tag8;
  AItem.Tag9 := ASpecificItem.Tag9;
  AItem.Tag10 := ASpecificItem.Tag10;
  AItem.TextTag1 := ASpecificItem.TextTag1;
  AItem.TextTag2 := ASpecificItem.TextTag2;
  AItem.TextTag3 := ASpecificItem.TextTag3;
  AItem.TextTag4 := ASpecificItem.TextTag4;
  AItem.TextTag5 := ASpecificItem.TextTag5;
  AItem.Style.GradientBeginColor := ASpecificItem.Style.GradientBeginColor;
  AItem.Style.GradientEndColor := ASpecificItem.Style.GradientBeginColor;
  AItem.Style.BorderColor := ASpecificItem.Style.GradientBeginColor;
  Result := AItem;
end;

function TdxTileControlGroup.AddItem(ALogicState: TStateItemLogic; AGroupingIndex, AFontSize: Integer
                    ; AText1: string; AFontStyle1: TFontStyles
                    ; AText2: string; AFontStyle2: TFontStyles): TdxTileControlItem;
var
  AItem: TdxTileControlItem;
begin
  CheckLogicControl(AGroupingIndex);
  ...
  AItem.Text1.Font.Size := AFontSize;
  AItem.Text1.Font.Name := 'Segoe UI';
  AItem.Text1.Font.Style := AFontStyle1;
  AItem.Text1.Align := oaTopLeft;

  if (AFontSize = 14) then
    AItem.Text1.IndentVert := -6
  else
    AItem.Text1.IndentVert := -4;

  AItem.Text1.Value := AItem.TextCut(AText1);

  AItem.Text2.TextColor := clBlack;
  AItem.Text2.Font.Size := AFontSize;
  AItem.Text2.Font.Style := AFontStyle2;
  AItem.Text2.Align := oaTopRight;
  AItem.Text2.Font.Name := 'Segoe UI';
  if (AFontSize = 14) then
    AItem.Text2.IndentVert := -6
  else
    AItem.Text2.IndentVert := -4;

  AItem.Text2.Value := AText2;
  Result := AItem;
end;

function TdxTileControlGroup.AddItem(ASpecificItem: TdxTileControlItem
                    ;ALogicState: TStateItemLogic
                    ; AGroupingIndex, AFontSize: Integer
                    ; AText1: string; AFontStyle1: TFontStyles
                    ; AText2: string; AFontStyle2: TFontStyles): TdxTileControlItem;
...
procedure TdxTileControlGroup.AddSeparator;
var
  AItem: TdxTileControlItem;
begin
  AItem := TileControl.Items.Add;
  AItem.UniqGroupingIndex := -1;
  AItem.LogicState := itlNone;
  AItem.Group := Self;
  AItem.Style.GradientBeginColor := clWhite;
  AItem.Style.GradientEndColor := clWhite;
  AItem.Style.BorderColor := clWhite;
  AItem.Text1.TextColor :=  clGray;
  AItem.Text1.Font.Size := 14;
  AItem.Text1.Font.Style := [fsbold];
  AItem.Text1.Align := oaTopLeft;
  AItem.Text1.IndentVert := -15;

  if AItem.IndexInGroup > 0 then
    AItem.Text1.Value := '____________________________________';
end;
...
begin
  if (AVirtualGroup = VirtualGroupAfter) and not IsMostRight then
    Result := cxGetValueCurrentDPI(Indent)
  else
    Result := 0;
end;
...
function TdxTileControlGroup.GetShowContent: Boolean;
var
  Index: Integer;
begin
  Result := False;
...
var
  ...
  ATop: Integer;
  s: TStringList;
  DefaultCanvasColor, DefaultCanvasPenWidth: integer;
begin

  ABounds := ADrawRect;
  ATextColor := clNone;
  try
    if TileControl.FUseAmazingGroup then
      Group.FRectGroup.BoundsRect := ABounds;
    ...
    begin
     ...
     // ATop := 1; // 2х строчный Title
      ABounds.Top := ABounds.Top - 6;

      if TileControl.FUseAmazingGroup then
      begin
      //  TileControl.OptionsView.GroupIndent := 2;
        if Group.ItemCount = 0 then
          Exit;

        DefaultCanvasColor := ACanvas.Pen.Color;
        DefaultCanvasPenWidth := ACanvas.Pen.Width;
        ACanvas.Pen.Color := $00C5C5C5;
        ACanvas.Pen.Width := 3;

        if (Group.Items[0].Visible) then
        begin
            ACanvas.Line(Point(ABounds.Width - 15, ABounds.Bottom - 15)
                        , Point(ABounds.Width - 5, ABounds.Bottom - 7));
            ACanvas.Line(Point(ABounds.Width + 5, ABounds.Bottom - 15)
                        , Point(ABounds.Width - 5, ABounds.Bottom - 7));
          end else begin
            ACanvas.Line(Point(ABounds.Width - 15, ABounds.Bottom - 7)
                        , Point(ABounds.Width - 5, ABounds.Bottom - 15));
            ACanvas.Line(Point(ABounds.Width + 5, ABounds.Bottom - 7)
                        , Point(ABounds.Width - 5, ABounds.Bottom - 15));
          end;

        ACanvas.Pen.Color := DefaultCanvasColor;
        ACanvas.Pen.Width := DefaultCanvasPenWidth;
      end;
    end;

  finally
  {альтернатива HorizantalLine}
//    ACanvas.Line(Point(0, ABounds.Bottom-54)
//                , Point(ABounds.Width, ABounds.Bottom-54));


{здесь по факту будем делить текст на 2 строки с присвоением им разных шрифтов}
    if not (TileControl.FUseAmazingGroup) then
      ...
      try
        ...
        begin
          ATop := -21;
          ATop := Bounds.Bottom + ATop;
          ABounds.Bottom := ATop;
          ACanvas.FillRect(ABounds, Caption.Color);
          cxTextOut(ACanvas.Canvas, s.Strings[0], ABounds, GetTextOutFlags, 0, 0, Caption.Text1Font, clNone, clNone, 0, 0, 0, ATextColor);
        end;
      finally
        s.Free;
      end;
...
begin
  ...
  //    ATop := Bounds.Bottom + ATop;
  //    ABounds.Bottom := ATop;
  //    ABounds.Height := ABounds.Height + 10;
    end;
  ...
  begin
    ...
    DefaultCanvasColor := ACanvas.Pen.Color;
    DefaultCanvasPenWidth := ACanvas.Pen.Width;
    ACanvas.Pen.Color := clGray;// $00C5C5C5;
    ACanvas.Pen.Width := 2;

    if (Group.Items[0].Visible) then
    begin
        ACanvas.Line(Point(ABounds.Width - 12, ABounds.Bottom - 15)
                    , Point(ABounds.Width - 5, ABounds.Bottom - 7));
        ACanvas.Line(Point(ABounds.Width + 2, ABounds.Bottom - 15)
                    , Point(ABounds.Width - 5, ABounds.Bottom - 7));
      end else begin
        ACanvas.Line(Point(ABounds.Width - 12, ABounds.Bottom - 7)
                    , Point(ABounds.Width - 5, ABounds.Bottom - 15));
        ACanvas.Line(Point(ABounds.Width + 2, ABounds.Bottom - 7)
                    , Point(ABounds.Width - 5, ABounds.Bottom - 15));
      end;
...
const
  AHorzAlign: array[TAlignment] of TcxTextAlignX =
    (taLeft, taRight, taCenterX);
begin
  Result := cxMakeFormat(AHorzAlign[Caption.Alignment], taBottom) or CXTO_PREVENT_TOP_EXCEED or CXTO_END_ELLIPSIS;
end;
...
begin
  FHeight := 0;
  FIndent := TileControl.OptionsView.GetActualItemIndent;
  TileControl.Painter.ValidatePainterData;
...
begin
  ...
  FText1Font := TFont.Create;
  FText1Font.Color := clDefault;
  FText1Font.Name := DefaultFontName;
  FText1Font.Size := dxTileControlDefaultGroupCaptionFontSize;
  FText1Font.OnChange := FontChanged;

  FText2Font := TFont.Create;
  FText2Font.Color := clDefault;
  FText2Font.Name := DefaultFontName;
  FText2Font.Size := dxTileControlDefaultGroupCaptionFontSize;
  FText2Font.OnChange := FontChanged;
...
begin
  FreeAndNil(FText1Font);
  FreeAndNil(FText2Font);
  FreeAndNil(FFont);
  FreeAndNil(FViewInfo);
  inherited Destroy;
end;
...
procedure TdxTileControlGroupCaption.SetText1(Value: string);
begin
  Value := Trim(Value);
...
procedure TdxTileControlGroupCaption.SetText1Font(AValue: TFont);
begin
  FText1Font.Assign(AValue)
end;
...
procedure TdxTileControlGroupCaption.SetText2(Value: string);
begin
  Value := Trim(Value);
...
procedure TdxTileControlGroupCaption.SetText2Font(AValue: TFont);
begin
  FText2Font.Assign(AValue)
end;
...
begin
  ...
  if TileControl.FUseAmazingGroup then begin
    Result.FRectGroup := TTileClickedRect.Create(TileControl);
    Result.FRectGroup.BoundsRect := Result.FViewInfo.FBounds;

    Result.FRectGroup.Parent := TileControl;
    Result.FRectGroup.FOwnerGroup := Result;
  end;
...
begin
  ...
  FCountInfoFont.Size := dxTileControlDefaultGroupCaptionFontSize;
...
begin
  ...
  ASizeX := TileControl.ViewInfo.ItemSmallWidth + TileControl.OptionsView.GetActualItemIndent;
  ASizeY := TileControl.ViewInfo.ItemSmallHeight + TileControl.OptionsView.GetActualItemIndent;
...
begin
  Result := cxRectCenter(DragBounds).X - TileControl.OptionsView.GetActualItemWidth div 4;
end;

function TdxTileControlDragDropItem.GetSpecialPointY: Integer;
begin
  Result := DragBounds.Top + TileControl.OptionsView.GetActualItemHeight div 4;
end;
  ...
  try
    ...
    try
      ...
      try
        ...
        AImageCanvas.Line(ACenter.X - AHorn, ACenter.Y - AHorn, ACenter.X + AHorn, ACenter.Y + AHorn, $FF000000, 2);
        AImageCanvas.Line(ACenter.X - AHorn, ACenter.Y + AHorn, ACenter.X + AHorn, ACenter.Y - AHorn, $FF000000, 2);
      finally
...
procedure TdxTileControlGroupCaptionInplaceEdit.Initialize;
begin
...
begin
  ...
  ABoundsRect := cxRectInflate(ACaptionTextBounds, cxTextSpace, cxTextSpace);
...
begin
  ...
  dxAdjustToTouchableSize(AWidth);
...
{$IFDEF CXTEXT}
  Assert(ItemsContentAnimationLockCount >= 0, 'Invalid lock counter');
{$ENDIF}
...
procedure TdxTileControlController.SetFocusedItem(AValue: TdxTileControlItem);
  ...
  begin
    Result := True;
    if Assigned(TileControl.OnItemFocusChanging) then
...
begin
  ...
  begin
    ...
    if Assigned(TileControl.OnItemFocusChange) then
...
begin
//-----------------------Demyantsev 29.01.2019---------------------------
// убрали код из-за долгого добавления элементов в лист
// приводило к сильному замедлению кнопок добавления удаления товаров в чек
  {
...
function TdxTileControlOptionsView.GetActualGroupIndent: Integer;
begin
  Result := cxGetValueCurrentDPI(GroupIndent);
end;

function TdxTileControlOptionsView.GetActualIndentHorz: Integer;
begin
  Result := cxGetValueCurrentDPI(IndentHorz);
end;

function TdxTileControlOptionsView.GetActualIndentVert: Integer;
begin
  Result := cxGetValueCurrentDPI(IndentVert);
end;

function TdxTileControlOptionsView.GetActualItemHeight: Integer;
begin
  Result := cxGetValueCurrentDPI(ItemHeight);
end;

function TdxTileControlOptionsView.GetActualItemIndent: Integer;
begin
  Result := cxGetValueCurrentDPI(ItemIndent);
end;

function TdxTileControlOptionsView.GetActualItemWidth: Integer;
begin
  Result := cxGetValueCurrentDPI(ItemWidth);  // cxGraphics (ItemWidth * cxGetCurrentDPI div 96)
end;
...
function TdxTileControlOptionsView.ItemIndentStored: Boolean;
begin
  Result := FItemIndent <> GetDefaultItemIndent;
end;

function TdxTileControlOptionsView.ItemWidthStored: Boolean;
begin
...
function TdxTileControlTitle.GetActualIndentHorz: Integer;
begin
  Result := cxGetValueCurrentDPI(IndentHorz);
end;

function TdxTileControlTitle.GetActualIndentVert: Integer;
begin
  Result := cxGetValueCurrentDPI(IndentVert);
end;
...
function TdxTileControlActionBars.GetActualIndentHorz: Integer;
begin
  Result := cxGetValueCurrentDPI(IndentHorz);
end;

function TdxTileControlActionBars.GetActualIndentVert: Integer;
begin
  Result := cxGetValueCurrentDPI(IndentVert);
end;

function TdxTileControlActionBars.GetActualItemIndent: Integer;
begin
  Result := cxGetValueCurrentDPI(ItemIndent);
end;
...
begin
  FItemHalfIndent := TileControl.OptionsView.GetActualItemIndent div 2;
  FItemSmallHeight := (TileControl.OptionsView.GetActualItemHeight - TileControl.OptionsView.GetActualItemIndent) div 2;
  FItemSmallWidth := (TileControl.OptionsView.GetActualItemWidth - TileControl.OptionsView.GetActualItemIndent) div 2;
  FItemLargeWidth := 2 * TileControl.OptionsView.GetActualItemWidth + TileControl.OptionsView.GetActualItemIndent;
end;
...
begin
  Result := TilesZone;
  if TileControl.OptionsView.FixedIndentHorz then
    Result := cxRectInflate(Result, -TileControl.OptionsView.GetActualIndentHorz, 0);
  if TileControl.OptionsView.FixedIndentVert then
    Result := cxRectInflate(Result, 0, -TileControl.OptionsView.GetActualIndentVert);
end;
...
begin
  ...
  begin
    ...
    if not TileControl.OptionsView.FixedIndentVert then
      Dec(AUsefulHeight, 2 * TileControl.OptionsView.GetActualIndentVert);
    AItemIndent := TileControl.OptionsView.GetActualItemIndent;
    ARegularItemHeight := TileControl.OptionsView.GetActualItemHeight + AItemIndent;
...
begin
  ...
  begin
    ...
    ARealContentRight := Max(Result.Right, AGroup.ViewInfo.ItemsRight + TileControl.OptionsView.GetActualIndentHorz);
    Result.Left := Min(Result.Left, ABounds.Left);
    Result.Bottom := Max(Result.Bottom, AGroup.ViewInfo.ItemsBottom + TileControl.OptionsView.GetActualIndentVert);
    if GroupLayout = glHorizontal then
    begin
      Result.Top := Min(Result.Top, AGroup.Caption.Bounds.Top - TileControl.OptionsView.GetActualIndentVert);
    ...
    begin
      if TileControl.OptionsView.FixedIndentHorz then
        Dec(Result.Right, cxGetValueCurrentDPI(1));
      if TileControl.OptionsView.FixedIndentVert then
        Dec(Result.Bottom, cxGetValueCurrentDPI(1));
    end;
  end;
  ...
  if TileControl.OptionsView.FixedIndentVert and (AHeight > 0) and (AHeight > TileControl.OptionsView.IndentVert) then
    Result := cxRectInflate(Result, 0, -TileControl.OptionsView.GetActualIndentVert);
  FRealContentWidth := cxRectWidth(Result);
end;
...
procedure TdxTileControlPainter.DrawGlyph(ACanvas: TcxCanvas; const R: TRect;
  AState: TcxButtonState; AGlyph: TdxSkinImage; AGlyphType: TImageType; AColor: TColor);
const
...
procedure TdxTileControlPainter.DrawDefaultItemCheck(ACanvas: TcxCanvas;
  const R: TRect; ABackgroundColor, ACheckMarkColor: TColor; AAlpha: Byte = MaxByte); // dorofeev 20.12.2019(сделать нормально настройкой !!!)
  var
    eps_x, eps_y: Integer;
  ...
  begin
    if (TileControl.OptionsBehavior.ItemCheckMode = tcicmMultiple) then
      begin
        // изменение смещения координат региона и галочки для чекбокса в зависимости от выбранного для него положения
        case TileControl.CheckBoxPosition of
          oaTopLeft:
            begin
              eps_x := TileControl.OptionsView.ItemWidth - 28;
              eps_y := -4;
            end;
          oaTopCenter:
            begin
              eps_x := (TileControl.OptionsView.ItemWidth - 28) div 2;
              eps_y := -4;
            end;
          oaTopRight:
            begin
          ...
          oaMiddleLeft, oaDefault:
            begin
              eps_x := TileControl.OptionsView.ItemWidth - 28;
              eps_y := (TileControl.OptionsView.ItemHeight - 38) div 2;
            end;
          oaMiddleCenter:
            begin
              eps_x := (TileControl.OptionsView.ItemWidth - 28) div 2;
          ...
          oaBottomLeft:
            begin
              eps_x := TileControl.OptionsView.ItemWidth - 28;
              eps_y := TileControl.OptionsView.ItemHeight - 32;
            end;
          oaBottomCenter:
            begin
              eps_x := (TileControl.OptionsView.ItemWidth - 28) div 2;
...
//        eps_x := TileControl.OptionsView.ItemWidth - 29;
//        eps_y := (TileControl.OptionsView.ItemHeight - 34) div 2 - 4;
      end
      else
      begin
        eps_x := 0;
  ...
  //  eps_y := Amy;
    APoints[0] := cxPoint(R.Right - cxGetValueCurrentDPI(dxTileCheckedItemCheckMarkAreaSize) - eps_x, R.Top + eps_y);
    APoints[1] := cxPoint(R.Right- eps_x, R.Top + eps_y);
    APoints[2] := cxPoint(R.Right- eps_x, R.Top + cxGetValueCurrentDPI(dxTileCheckedItemCheckMarkAreaSize) + eps_y);

    Result := TcxRegion.Create(R);
    Result.Combine(cxRectInflate(R, -cxGetValueCurrentDPI(dxTileCheckedItemFrameBorderSize),
      -cxGetValueCurrentDPI(dxTileCheckedItemFrameBorderSize)), roSubtract);
  ...
  begin
    ACheckMarkAreaHalfSize := cxGetValueCurrentDPI(dxTileCheckedItemCheckMarkAreaSize) div 2;
    Result := cxRectSetHeight(R, MulDiv(ACheckMarkAreaHalfSize, 8, 9));
    Result := cxRectSetRight(Result, Result.Right, ACheckMarkAreaHalfSize);
    Result := cxRectInflate(Result, 0, -2 * cxGetValueCurrentDPI(dxTileCheckedItemFrameBorderSize),
      -2 * cxGetValueCurrentDPI(dxTileCheckedItemFrameBorderSize), 0);
  end;
  ...
  begin
    ...
    APoints[0] := cxPoint(ACheckMarkArea.Right - eps_x, ACheckMarkArea.Top + eps_y);
    APoints[1] := cxPoint((ACheckMarkArea.Left + ACheckMarkArea.Right) div 2 - eps_x, ACheckMarkArea.Bottom + eps_y);
    APoints[2] := cxPoint(ACheckMarkArea.Left - eps_x, (ACheckMarkArea.Bottom + ACheckMarkArea.Top) div 2 + eps_y);
    APrevSmoothingMode := dxGPPaintCanvas.SmoothingMode;
    try
      dxGPPaintCanvas.SmoothingMode := smAntiAlias;
      if TileControl.UseAmazingGroup then
        APenWidth := 2
      else
        APenWidth := cxGetValueCurrentDPI(dxTileCheckedItemCheckMarkPenSize);

      dxGPPaintCanvas.Polyline(APoints, AColor, APenWidth, psSolid, AAlpha);
    finally
  ...
  try
    ...
    try
      if ABackgroundColor <> clNone then
        dxGpFillRect(dxGPPaintCanvas.Handle, R, dxColorToAlphaColor(ABackgroundColor, AAlpha));
      if ACheckMarkColor <> clNone then begin
...
begin
  if TileControl.OptionsBehavior.ItemCheckMode = tcicmNone then
    Exit;
...
begin
  ...
  if (R.Right - AFrameSize - 1 >= ATilesArea.Right) or
    (AHasScrollBar and TileControl.VScrollBarVisible and (R.Right >= TileControl.GetVScrollBarBounds.Left - 1)) then
  ...
  if (R.Bottom - AFrameSize - 1 >= ATilesArea.Bottom) or
    (AHasScrollBar and TileControl.HScrollBarVisible and (R.Bottom >= TileControl.GetHScrollBarBounds.Top - 1)) then
...
begin
  ...
  cxTextOut(ACanvas.Canvas, Caption, ATextRect, CXTO_CENTER_HORIZONTALLY or CXTO_CENTER_VERTICALLY,
...
begin
  Result := cxTextHeight(Font, Caption) + cxGetValueCurrentDPI(cxMarginsHeight(GetContentOffsets));
  dxAdjustToTouchableSize(Result);
end;

function TdxTileControlPageTabCellViewInfo.MeasureWidth: Integer;
begin
  Result := cxTextWidth(Font, Caption) + cxGetValueCurrentDPI(GetMarginsWidth);
  dxAdjustToTouchableSize(Result);
end;
...
begin
  Result := cxGetValueCurrentDPI(Texture.Size.cy);
end;

function TdxTileControlCustomButtonViewInfo.MeasureWidth: Integer;
begin
  Result := cxGetValueCurrentDPI(Texture.Size.cx);
end;
...
begin
  ASizeX := Owner.LookAndFeelPainter.SliderButtonSize(FDirection).cx;
  ASizeY := Owner.LookAndFeelPainter.SliderButtonSize(FDirection).cy;
...
procedure TdxTileControlScrollButtonViewInfo.DoCalculateTopLeft(const ASizeX, ASizeY: Integer; var ATop, ALeft: Integer);
  ...
  begin
    ...
    AOwnerIndentHorz := Owner.OptionsView.GetActualIndentHorz;
    ...
    AOwnerIndentVert := Owner.OptionsView.GetActualIndentVert;
...
begin
  ...
  begin
    ...
    FTabsBounds := cxRectSetXPos(Bounds,
      ...
      Min(FGlyphBounds.Left, Bounds.Right - TileControl.OptionsView.GetActualIndentHorz));
    ...
    begin
      ...
      FTabsBounds := cxRectInflate(FTabsBounds, -(AScrollButtonWidth + cxTextOffset), 0);
      RestorePriorTabsLeftScrollPos;
      if cxRectWidth(FTabsBounds) <= 2 * cxTextOffset then
        DestroyScrollTabsButtons;
    end
    else
...
begin
  Result := Tabs[0].Bounds.Left < TabsBounds.Left - cxTextOffset;
end;

function TdxTileControlDetailSiteTitleViewInfo.CanScrollTabToRight: Boolean;
begin
  Result := Tabs[Tabs.Count - 1].Bounds.Right > TabsBounds.Right + cxTextOffset;
end;
...
begin
  Result := Max(inherited GetHeight, BackButtonViewInfo.MeasureHeight + 2 * Title.GetActualIndentVert);
end;
...
begin
  ...
  Result.Bottom := Max(Result.Bottom,
    Result.Top + BackButtonViewInfo.MeasureHeight + Title.GetActualIndentVert * 2);
end;
...
begin
  ...
  ControlStyle := ControlStyle + [csOpaque, csAcceptsControls, csNoDesignVisible]; // dorofeev 26/03/2020 [csOpaque]
  Visible := False;
  TabStop := False;
end;
...
begin
  ...
  AIndentHorz := TileControl.OptionsView.GetActualIndentHorz;
  AIndentVert := TileControl.OptionsView.GetActualIndentVert;
...
begin
  ...
  InitializeAlign;
  CreateSubClasses;
  FUseAmazingGroup := False;
  FRoundRectRatio := 7; // def RoundRect;
  FUseAmazingRoundRect := True; // def use roundrect
  VirtualItems := TList<Integer>.Create; // dorofeev 12.04.2021
  FSelectColor := cPrimeraSelectedColor; // dorofeev 28/04/2021
end;
...
begin
  Inc(FLockCount);
  SaveChangeState;
//  FScrollPos := ViewInfo.TopScrollPos;
end;

procedure TdxCustomTileControl.CancelUpdate;
begin
  Dec(FLockCount);
  ViewInfo.TopScrollPos := FScrollPos;
...
procedure TdxCustomTileControl.EndUpdateDefRender;
begin
  Dec(FLockCount);
  LayoutChangedDefRender;
end;
...
function TdxCustomTileControl.GetOnceChecked: Boolean;
var
  i: Integer;
begin
  Result := False;
...
begin
  ...
  try
    ...
    try
      ...
      FAnimation := TdxImageAnimationTransition.Create(
        AStartImage, AFinishImage, OptionsDetailAnimate.AnimationInterval, GetAnimationMode);
...
begin
  Result := TdxDrawAnimationMode(Sign(AIndex1 - AIndex2) + 1);
end;
...
procedure TdxCustomTileControl.DoChangeState;
begin
//
end;
...
{IFDEF CXTEST}
function TdxCustomTileControl.GetIsDesigning: Boolean;
begin
  Result := inherited GetIsDesigning or DesignTimeEmulation;
end;
{ENDIF}
...
procedure TdxCustomTileControl.LayoutChangedDefRender;
begin
  Changes := Changes + [tccLayout];
  if IsLocked then Exit;
  if AutoSize then
...
procedure TdxCustomTileControl.SaveChangeState;
begin
//
end;
...
procedure TdxCustomTileControl.SetAmazingGroup(AUse: Boolean);
begin
  FUseAmazingGroup := AUse;
end;
...
procedure TdxCustomTileControl.SetCustomTag(const Value: Integer);
begin
  FCustomTag := Value;
end;
...
procedure TdxCustomTileControl.SetImgToGroup(const APath: string);
begin
{    ts := TTileShape.Create(self);
    bmp := TBitMap.Create;
    try
      bmp.LoadFromFile(APath);
      bmp.Transparent := True;
//  for i := 0 to FCustomTitlesGroups.Count - 1 do begin
      ts := TTileShape.Create(self);
   //   ts.Parent := FCustomTitlesShapes.Items[0];
      ts.Pen.Style := psClear;
      ts.Brush.Style := bsClear;
      ts.Canvas.Draw(10, 10, bmp);
      ts.SaveCanvas;
//  end;
...
procedure TdxCustomTileControl.SetTransparent(AValue: Boolean);
begin
  if FTransparent <> AValue then
  begin
    FTransparent := AValue;
...
var
  ...
  I: Integer;
begin
  ABounds := cxRectInflate(ABounds, -ActionBars.GetActualIndentHorz, -ActionBars.GetActualIndentVert);
  ...
  begin
    ...
    begin
      ...
      ABounds.Left := AItemViewInfo.Bounds.Right + ActionBars.GetActualItemIndent;
    end;
  end;
  ...
  begin
    ...
    begin
      ...
      ABounds.Right := AItemViewInfo.Bounds.Left - ActionBars.GetActualItemIndent;
    end;
  end;
end;
...
begin
  ...
  if Result > 0 then
    Inc(Result, 2 * ActionBars.GetActualIndentVert);
end;
...
begin
  inherited DoCalculate;
  FGlyphBounds := cxRectSetHeight(cxRectCenterHorizontally(Bounds, cxGetValueCurrentDPI(Texture.Size.cx)),
    cxGetValueCurrentDPI(Texture.Size.cy));
end;
...
begin
  ...
  begin
    R := TextBounds;
    cxTextOut(ACanvas.Handle, Text, R, CXTO_CENTER_HORIZONTALLY or CXTO_CENTER_VERTICALLY, Font, 0, 0, 0, TextColor);
  end;
end;
...
begin
  ...
  begin
    ...
    ABackButtonBounds := cxRectInflate(ABounds, -ActionBars.GetActualIndentHorz, -ActionBars.GetActualIndentVert);
