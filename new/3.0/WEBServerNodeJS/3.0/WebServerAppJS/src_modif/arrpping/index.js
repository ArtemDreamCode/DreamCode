...
function Arpping({
    ...
    //    interface: [ 'lo0', 'en0', 'en1', 'wlan0', 'eth0', 'Подключение по локальной сети', 'Беспроводная сеть'], // modifis by 25/07/2021
	       interface: [ 'lo0', 'en0', 'en1', 'eth0', 'wlan0', 'Подключение по локальной сети', 'Беспроводная сеть'],
        internal: [ false ],
        family: [ 'IPv4' ]
    }, interfaceFilters);
...
Arpping.prototype.getConnection = function({
	...
	console.log(interfaces) // modifis by 25/07/2021
