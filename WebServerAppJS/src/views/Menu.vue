<template>
    <div class = "home-page">
        ...
        <div class="controls-button">
			...
			<div v-if="devs.length > 0"   class="message-count-blue">
                    <span class = "message-count__number">{{devs.length}}</span>
                </div>
            ...
            <a @click="scan_dev" class="constrols__item router--devices">
